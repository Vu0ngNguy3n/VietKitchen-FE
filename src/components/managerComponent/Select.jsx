...
export const Select = ({ options, value, onChange }) => {
    ...
    const opt = useMemo(() => {
        ...
        const OPTIONS = options.filter(
            (o) =>
                ((o.name.toString().toLowerCase().indexOf(search.toString().toLowerCase()) !==-1)||(o.slug.toString().toLowerCase().indexOf(search.toString().toLowerCase()) !==-1))
        );
