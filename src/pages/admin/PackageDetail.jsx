                            ...
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div className="col-span-2 sm:col-span-1">
                                    ...
                                    className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg
                                     ...
                                     dark:focus:ring-blue-800 w-full" type="button"  onClick={() => handleOpenDropdown()}>Danh sách các chức năng 
                                     <svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" 
                                     xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                        <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
                                    </svg></button>

                                    <div id="dropdownSearch" className={`z-10  bg-white ${isOpenDropDown ? '' :"hidden"} rounded-lg shadow w-60 dark:bg-gray-700`}>
                                       
                                        <ul className="h-48 px-3 pb-3 mt-4 overflow-y-auto text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownSearchButton">
                                            {permissionsList?.map((permission, index) => (
                                                <li key={index}>
                                                    ...
                                                    <label htmlFor="checkbox-item-11" className="w-full ms-2 text-sm font-medium text-gray-900 rounded dark:text-gray-300">{permission?.name}</label>
                                                    </div>
                                                </li>
                                            ))}
