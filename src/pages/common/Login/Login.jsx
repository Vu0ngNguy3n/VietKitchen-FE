          ...
          <div className="w-1/2  h-full bg-[#f5f5f5] flex flex-col p-20 justify-between items-center">
              ...
              <div className="w-full flex flex-col ">
                  <div className="w-full flex flex-col mb-2">
                      ...
                      <p className="text-base mb-2 text-blue-500">Xin chào! {typeLogin === 1 ? "Đăng nhập với tư cách quản trị viên hệ thống" : "Đăng nhập với tư cách nhân viên"}</p>
                  </div>
                  <div className="flex w-full justify-around ">
                      <div className={`border-b-2  pb-1 cursor-pointer transition duration-500 ease-in-out ${typeLogin === 1?'border-blue-700':"border-black"}`} onClick={() => handleChangeTypeLogin(1)}>
                          <h3 className="font-semibold">Chủ nhà hàng/ Quản lý</h3>
                      </div>
                      <div className={`border-b-2  pb-1 cursor-pointer transition duration-500 ease-in-out ${typeLogin === 2?'border-blue-700':"border-black"}`}   onClick={() => handleChangeTypeLogin(2)}>
                  ...
                  <div className="w-full flex flex-col my-4">
                      ...
                      <button className="w-full text-[#060606] my-2 font-semibold bg-white border-2 border-black-2 rounded-md p-4 text-center flex items-center justify-center" onClick={() => navigate("/signUp")}>
                          Đăng ký
                      </button>
                  </div>
              ...
              <div className="w-full flex  items-center justify-center">
                <p className="text-sm font-normal text-[#060606]">Không có tài khoản? <span className="font-semibold underline underline-offset-2 cursor-pointer" onClick={() => navigate('/signUp')}> Đăng ký</span></p>
              </div>
          </div>
