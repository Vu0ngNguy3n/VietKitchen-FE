...
function RestaurantInformation() {
    ...
    function handleUpdate() {
        ...
        if(username.trim() === '' || address.trim() === '' || provinceResult === ''){
            toast.warn("Vui lòng điền đầy đủ thông tin nhà hàng")
        }else{
            ...
            if(restaurantInformation === null) {
                ...
                axiosInstance
                    ...
                    .then(res => {
                        toast.success("Tạo thông tin nhà hàng thành công!")
                        ...
                        <div className="min-w-[40]x rounded-lg bg-white p-16 shadow min-h-[40vh] mt-2 relative">
                            ...
                            <div className="grid gap-4 mb-4 grid-cols-2">
                                <div className="col-span-2 ">
                                    <label htmlFor="username" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên nhà hàng của bạn</label>
                                    <input
                                        type="text"
                                        name="username"
                                        id="username"
                            ...
                            >
                                ...
                                {restaurantInformation === null ? 'Tạo nhà Hàng' : "Cập nhật"}
                            </button>
                            {/* </form> */}
                        </div>
                    </div>
